...
import { XTestCliCommon } from './x-test-cli-common.js';

export class XTestPuppeteerCli {
  /**
  ...
  static async run(options) {
    ...
    try {
      ...
      await page.evaluate(XTestCliCommon.run());

      // Handle coverage if collected
      if (coverage && page.coverage) {
        const js = await page.coverage.stopJSCoverage();
        await page.evaluate(XTestCliCommon.cover(), { js });
      }
